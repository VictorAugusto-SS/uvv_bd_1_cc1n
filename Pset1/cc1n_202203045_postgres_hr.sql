...
COMMENT ON TABLE hr.cargos IS 'tabela que aramazena os cargos e as informações relacionadas a eles';
COMMENT ON COLUMN hr.cargos.id_cargo IS 'código do cargo, chave primária';
COMMENT ON COLUMN hr.cargos.cargo IS 'nome do cargo';
COMMENT ON COLUMN hr.cargos.salario_minimo IS 'salário mínimo relacionado a tal cargo';
COMMENT ON COLUMN hr.cargos.salario_maximo IS 'salario máximo relacionado a tal cargo';
...
COMMENT ON TABLE hr.regioes IS 'Tabela feita para armazenar regiões e as informações relacionadas a elas';
COMMENT ON COLUMN hr.regioes.id_regiao IS 'código da região, chave primária';
...
COMMENT ON TABLE hr.paises IS 'Tabela que aramazena os países e as informações relacionadas a eles';
COMMENT ON COLUMN hr.paises.id_pais IS 'codigo do país, chave primária';
COMMENT ON COLUMN hr.paises.nome IS 'nome do país';
COMMENT ON COLUMN hr.paises.id_regiao IS 'chave estrangeira que identifica a região';
...
COMMENT ON TABLE hr.localizacoes IS 'Tabela que armazena localizações e as informações relacionadas a elas';
COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'código da localização, chave primária';
COMMENT ON COLUMN hr.localizacoes.endereco IS 'endereço de um escritório ou facilidade da empresa';
COMMENT ON COLUMN hr.localizacoes.cep IS 'CEP da localização relacionada ao endereço';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'cidade onde esta situado o endereço';
COMMENT ON COLUMN hr.localizacoes.uf IS 'estado onde está situado o endereço';
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'chave estrangeira que identifica o país';
...
COMMENT ON TABLE hr.departamentos IS 'tabela que armazena os departamentos e as informações relacionadas a eles';
COMMENT ON COLUMN hr.departamentos.id_departamento IS 'codigo do departamento, chave primária';
COMMENT ON COLUMN hr.departamentos.nome IS 'nome do departamento ';
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'chave estrangeira que identifica a localização';
COMMENT ON COLUMN hr.departamentos.id_gerente IS 'chave estrangeira que representa qual empregado é gerente do departamento, se houver';
...
COMMENT ON TABLE hr.empregados IS 'tabela que armazena os empregados e as informações relacionadas a eles';
COMMENT ON COLUMN hr.empregados.id_empregado IS 'código do empregado, chave primária';
COMMENT ON COLUMN hr.empregados.nome IS 'nome do empregado';
COMMENT ON COLUMN hr.empregados.email IS 'email do empregado até antes do arroba';
COMMENT ON COLUMN hr.empregados.telefone IS 'telefone do empregado ';
COMMENT ON COLUMN hr.empregados.data_contratacao IS 'data em que o empregado foi contratado';
COMMENT ON COLUMN hr.empregados.id_cargo IS 'chave estrangeira que identifica o cargo ';
COMMENT ON COLUMN hr.empregados.salario IS 'guarda o salário relacionado a tal empregado';
COMMENT ON COLUMN hr.empregados.comissao IS 'comissão relacionada a tal empregado';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'chave estrangeira que identifica o departamento que tal empregado está inserido';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'cahve estrangeira que provém do auto-relacionamento da tabela empregados;
...
COMMENT ON TABLE hr.historico_cargos IS 'tabela que armazena o histórico de cargos e as informações relacionadas a ele';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'parte chave primária da tabela e chave estrangeira que identifica o empregado';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'data inicial do histórico, chave primária';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'data final do histórico';
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'chave estrangeira que identifica o cargo ';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'chave estrangeira que identifica o departamento';
